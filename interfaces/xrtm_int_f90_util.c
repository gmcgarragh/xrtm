...
int xrtm_solution_bindx_f90(xrtm_data *d, enum xrtm_solver_mask solver, int solutions, int n_phis, double *phis, double *I_p, double *I_m, double *K_p, double *K_m, double *mean_p, double *mean_m, double *mean_p_l, double *mean_m_l, double *flux_p, double *flux_m, double *flux_p_l, double *flux_m_l, double *flux_div, double *flux_div_l) {
     ...
     if (xrtm_solution(d, solver, solutions, n_phis, phis2, I_p2, I_m2, K_p2, K_m2, mean_p, mean_m, mean_p_l2, mean_m_l2, flux_p, flux_m, flux_p_l2, flux_m_l2, flux_div, flux_div_l2)) {
...
int xrtm_radiance_bindx_f90(xrtm_data *d, enum xrtm_solver_mask solver, int n_phis, double *phis, double *I_p, double *I_m, double *K_p, double *K_m) {
     double **phis2;
     double ****I_p2;
     double ****I_m2;
     double *****K_p2;
     ...
     K_p2 = array_from_mem5_d(K_p, d->n_ulevels, d->n_derivs, d->n_umus == 0 ? d->n_quad : d->n_umus, n_phis, d->n_stokes);
     K_m2 = array_from_mem5_d(K_m, d->n_ulevels, d->n_derivs, d->n_umus == 0 ? d->n_quad : d->n_umus, n_phis, d->n_stokes);
     if (xrtm_radiance(d, solver, n_phis, phis2, I_p2, I_m2, K_p2, K_m2)) {
