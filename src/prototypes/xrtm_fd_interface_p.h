/* xrtm_fd_interface.c */
int xrtm_fd_method_n(void);
int xrtm_fd_method_max_name_length(void);
const char *xrtm_fd_method_index_to_name(int index);
int xrtm_fd_method_name_to_index(const char *name);
enum xrtm_fd_method_type xrtm_fd_method_index_to_value(int index);
int xrtm_fd_method_value_to_index(enum xrtm_fd_method_type type);
enum xrtm_fd_method_type xrtm_fd_method_name_to_value(const char *name);
const char *xrtm_fd_method_value_to_name(enum xrtm_fd_method_type type);
