...
void get_local_r_t_u_w_tl_with_ad(xrtm_data *d, int i_four, int i_layer, double **r_p, double **t_p, double **r_m, double **t_m, double ***r_p_l, double ***t_p_l, double ***r_m_l, double ***t_m_l, int flag, save_tree_data save_tree, work_data work);
void get_layer_R_T_S_U_W_V_tl_with_ad(xrtm_data *d, int i_four, int i_layer, int solver, double **R_p, double **T_p, double **R_m, double **T_m, double *S_p, double *S_m, double ***R_p_l, double ***T_p_l, double ***R_m_l, double ***T_m_l, double **S_p_l, double **S_m_l, int flag, save_tree_data save_tree, work_data work);
void get_total_TOA_R_S_U_V_tl_with_ad(xrtm_data *d, int i_four, int solver, double **Rs_qq, double *S_s, double ***Rs_qq_l, double **S_s_l, double **R_m, double *S_p, double ***R_m_l, double **S_p_l, int surface, int flag, save_tree_data save_tree, work_data work);
void get_total_R_T_S_U_W_V_tl_with_ad(xrtm_data *d, int i_four, int solver, double **R_p, double **T_p, double **R_m, double **T_m, double *S_p, double *S_m, double ***R_p_l, double ***T_p_l, double ***R_m_l, double ***T_m_l, double **S_p_l, double **S_m_l, int flag, save_tree_data save_tree, work_data work);
