...
int get_local_r_t_u_w(xrtm_data *d, int i_four, int i_layer, double ***r_p, double ***t_p, double ***r_m, double ***t_m, double ****r_p_l, double ****t_p_l, double ****r_m_l, double ****t_m_l, int flag, save_tree_data save_tree, work_data *work);
