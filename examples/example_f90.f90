...
program example_f90
     ...
     call xrtm_create_f90(xrtm, options, solvers, max_coef, n_quad, n_stokes, &
                          n_derivs, n_layers, n_kernels, n_kernel_quad, kernels, &
     ...
     do i = 1, n_out_levels
          ...
          print '("     intensity:")'
          do j = 1, n_out_thetas
               print '("          theta = ", ES9.2, ", I_p = ", ES13.6, ", I_m = ", ES13.6)', out_thetas(j), I_p(1,1,j,i), I_m(1,1,j,i)
          enddo
          do j = 1, n_derivs
               print '("     derivative: ", I1)', j
               do k = 1, n_out_thetas
                    print '("          theta = ", ES9.2, ", K_p = ", ES13.6, ", K_m = ", ES13.6)', out_thetas(k), K_p(1,1,k,j,i), K_m(1,1,k,j,i)
               enddo
          enddo
     enddo
